...
app.post('/user', [verifyToken, verifyAdminRol], (req, res) => {
  let body = req.body;
...
app.put('/user/:id_user', [verifyToken, verifyAdminRol], (req, res) => {
...
app.delete('/user/:id_user', [verifyToken, verifyAdminRol], (req, res) => {
